    ...
    <x-slot:header>
        ...
        <div>
            <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
                <div>
                    <form class="max-w-md mx-auto" action="{{route('alunos-controller.update',['aluno' => $aluno->id])}}" method="POST">
                        @csrf
                        ...
                        <div style="margin-top: 15px;">
                            <div style="margin-left: 20px; margin-right: 20px;" class="grid md:grid-cols-2 md:gap-6">
                                ...
                                <div style="margin-left: 10px;" class="relative z-0 w-full mb-5 group">
                                    ...
                                    <input required type="text" name="email" value="{{$aluno->email}}" class="block py-2.5 peer w-full text-gray-600 bg-gray-300 p-2 rounded shadow-sm border border-gray-300 focus:outline-none focus:bg-white mt-2">
                            ...
                            <div style="margin-left: 20px; margin-right: 20px; margin-top:20px" class="grid md:grid-cols-2 md:gap-6">
                                <div class="grid md:grid-cols-2 md:gap-6">
                                    ...
                                    <div style="margin-left: 5px;" class="relative z-0 w-full mb-5 group">
                                        ...
                                        <input required value="{{$aluno->birthday}}" type="datetime" name="birthday" class="block py-2.5 peer w-full text-gray-600 bg-gray-300 p-2 rounded shadow-sm border border-gray-300 focus:outline-none focus:bg-white mt-2">
                                    </div>
                                </div>
                                <div style="margin-left: 15px;" class="grid md:grid-cols-2 md:gap-6">
                                    <div class="relative z-0 w-full mb-5 group">
                                        <label class="text-gray-600">RG:</label>
                                        <input required type="tel" name="rg" value="{{$aluno->rg}}" minlength="10" maxlength="10" pattern="[0-9]+$" class="block py-2.5 peer w-full text-gray-600 bg-gray-300 p-2 rounded shadow-sm border border-gray-300 focus:outline-none focus:bg-white mt-2">
                                        <span id="rgError" style="color:red; display:none;">RG já existe!</span>
                                    </div>
                                    <div style="margin-left:10px;" class="relative z-0 w-full mb-5 group">
                                        <label class="text-gray-600">CPF:</label>
                                        <input required type="tel" name="cpf" value="{{$aluno->cpf}}" minlength="11" maxlength="11" pattern="[0-9]+$" class="block py-2.5 peer w-full text-gray-600 bg-gray-300 p-2 rounded shadow-sm border border-gray-300 focus:outline-none focus:bg-white mt-2">
                            ...
                            <div style="margin-left: 20px; margin-right: 20px; margin-top:20px" class="grid md:grid-cols-2 md:gap-6">
                                <div class="grid md:grid-cols-2 md:gap-6">
                                    <div class="relative z-0 w-full mb-5 group">
                                        ...
                                        <input value="{{$aluno->nationality}}" type="text" name="nationality" class="block py-2.5 peer w-full text-gray-600 bg-gray-300 p-2 rounded shadow-sm border border-gray-300 focus:outline-none focus:bg-white mt-2">
                                    </div>
                                    <div style="margin-left: 5px;" class="relative z-0 w-full mb-5 group">
                                ...
                                <div style="margin-left: 15px;" class="grid md:grid-cols-2 md:gap-6">
                                    ...
                                    <div style="margin-left: 10px;" class="grid md:grid-cols-2 md:gap-6">
                                        <div class="relative z-0 w-full mb-5 group">
                                            ...
                                            <input required value="{{$aluno->family_income}}" min="0" type="number" name="family_income" class="block py-2.5 peer w-full text-gray-600 bg-gray-300 p-2 rounded shadow-sm border border-gray-300 focus:outline-none focus:bg-white mt-2">
                                        </div>
                                        <div style="margin-left:10px;" class="relative z-0 w-full mb-5 group">
                                            <label class="text-gray-600">Grupo Familiar:</label>
                                            <input required value="{{$aluno->family_number}}" step="1" min="1" type="number" name="family_number" class="block py-2.5 peer w-full text-gray-600 bg-gray-300 p-2 rounded shadow-sm border border-gray-300 focus:outline-none focus:bg-white mt-2">
                                        </div>
                                        <input hidden type="text" name="password" value="{{$aluno->password}}">
                                    </div>
                                </div>
                            </div>
                        </div>
