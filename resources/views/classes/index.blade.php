    ...
    <form class="max-w-md mx-auto" action="{{ route('class-controller.store') }}" enctype="multipart/form-data"  method="POST">
        ...
        <div style="margin-top: 15px;">
            <div style="margin-left: 20px; margin-right: 20px;" class="grid  md:gap-12">
                ...
                <div class="w-64 mt-4">
                    <label for="multiselect" class="block text-sm font-medium text-gray-700">Seleção Múltipla</label>
                    <select id="multiselect" name="multiselect[]" multiple class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                ...
                <div style="margin-left: 20px; margin-right: 20px;">
                    <div class="w-64 mt-2" style=" mb-4">
                        ...
                        <input type="datetime-local" name="prazo_1" class="block py-2.5 peer w-full text-gray-600 bg-gray-300 p-2 rounded shadow-sm border border-gray-300 focus:outline-none focus:bg-white mt-2">
                    ...
                    <div class="w-64 mt-2 mb-4">
                        ...
                        <label class="text-gray-600">Prazo:</label>
                        <input type="datetime-local" name="prazo_2" class="block py-2.5 peer w-full text-gray-600 bg-gray-300 p-2 rounded shadow-sm border border-gray-300 focus:outline-none focus:bg-white mt-2">
                        <label class="text-gray-600">Arquivo:</label>
                    ...
                    <div class="w-64 mt-2 mb-4">
                        ...
                        <label class="text-gray-600">Prazo:</label>
                        <input type="datetime-local" name="prazo_3" class="block py-2.5 peer w-full text-gray-600 bg-gray-300 p-2 rounded shadow-sm border border-gray-300 focus:outline-none focus:bg-white mt-2">
                        <label class="text-gray-600">Arquivo:</label>
                    ...
                    <div class="w-64 mt-2 mb-4">
                        ...
                        <label class="text-gray-600">Prazo:</label>
                        <input type="datetime-local" name="prazo_4" class="block py-2.5 peer w-full text-gray-600 bg-gray-300 p-2 rounded shadow-sm border border-gray-300 focus:outline-none focus:bg-white mt-2">
                        <label class="text-gray-600">Arquivo:</label>
                    ...
                    <div class="w-64 mt-2 mb-4">
                        ...
                        <label class="text-gray-600">Prazo:</label>
                        <input type="datetime-local" name="prazo_5" class="block py-2.5 peer w-full text-gray-600 bg-gray-300 p-2 rounded shadow-sm border border-gray-300 focus:outline-none focus:bg-white mt-2">
                        <label class="text-gray-600">Arquivo:</label>
