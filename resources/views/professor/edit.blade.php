                ...
                <div>
                    <form action="{{route('professores-controller.update',['professor' => $professor->id])}}" method="POST">
                        ...
                        <div style="margin-top: 15px;">
                            ...
                            <div style="margin-left: 35px; margin-right: 30px" class="sm:flex items-center">
                                <input required type="text" size="60" name="name" value="{{$professor->name}}" class="text-gray-600 bg-gray-300 p-2 rounded shadow-sm border border-gray-300 focus:outline-none focus:bg-white mt-2">
                                <div style="margin-left: 30px;"></div>
                                <input required type="text" size="60" name="email" value="{{$professor->email}}" class="text-gray-600 bg-gray-300 p-2 rounded shadow-sm border border-gray-300 focus:outline-none focus:bg-white mt-2">
                            </div>
                            ...
                            <div style="margin-left: 35px; margin-right: 30px;" class="sm:flex items-center">
                                ...
                                <div style="margin-left: 30px;"></div>
                                <input value="{{$professor->birthday}}" style="width:250px; height:40px" type="datetime-local" name="birthday" class="text-gray-600 bg-gray-300 p-2 rounded shadow-sm border border-gray-300 focus:outline-none focus:bg-white mt-2">
                                <div style="margin-left: 30px;"></div>
                                <input size="26" type="tel" name="rg" value="{{$professor->rg}}" maxlength="10" class="text-gray-600 bg-gray-300 p-2 rounded shadow-sm border border-gray-300 focus:outline-none focus:bg-white mt-2">
                                <div style="margin-left: 30px;"></div>
                                <input size="26" type="tel" name="cpf" value="{{$professor->cpf}}" maxlength="11" class="text-gray-600 bg-gray-300 p-2 rounded shadow-sm border border-gray-300 focus:outline-none focus:bg-white mt-2">
                            </div>
                            <div style="margin-left: 35px; margin-right: 30px; margin-top:20px" class="sm:flex items-center">
                            ...
                            <div style="margin-left: 35px; margin-right: 30px;" class="sm:flex items-center">
                                <input value="{{$professor->nationality}}" type="text" size="25" name="nationality" class="text-gray-600 bg-gray-300 p-2 rounded shadow-sm border border-gray-300 focus:outline-none focus:bg-white mt-2">
                                <div style="margin-left: 30px;"></div>
                            ...
                            <div style="margin-left: 35px; margin-right: 30px;" class="sm:flex items-center">
                                <input value="{{$professor->family_income}}" style="width:230px; height:40px;" min="0" type="number" name="family_income" class="text-gray-600 bg-gray-300 p-2 rounded shadow-sm border border-gray-300 focus:outline-none focus:bg-white mt-2">
                                <div style="margin-left: 30px;"></div>
                                <input value="{{$professor->family_number}}" step="1" style="width:250px; height:40px;" min="0" type="number" name="family_number" class="text-gray-600 bg-gray-300 p-2 rounded shadow-sm border border-gray-300 focus:outline-none focus:bg-white mt-2">
                            </div>
                        </div>
